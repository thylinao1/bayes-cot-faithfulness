#!/bin/bash
# W6 external-validity copy of bcf/jury_wave.sh. The only thing that should call sbatch on
# bcf/w6_judge.sbatch. Job names are bcf-w6-*, which are the only jobs this lane may cancel.
#
...
#
#   bcf/w6_wave.sh --dry-run judges.tsv
#   bcf/w6_wave.sh judges.tsv
#
...
SBATCH_SCRIPT="${BCF_W6_SBATCH:-$HOME/bcf/repo-w6/bcf/w6_judge.sbatch}"
