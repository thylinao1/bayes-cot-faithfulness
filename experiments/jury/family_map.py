...
JUDGES: tuple[Judge, ...] = (
    ...
    Judge(
        ...
        serving_line="bf16, alone on one a100-80 at gpu-memory-utilization 0.90 (ruling R7)",
        gpu_type="a100-80",
        gpu_memory_utilization=0.90,
    ),
    Judge(
        ...
        serving_line="mxfp4, alone on one card at gpu-memory-utilization 0.90 (ruling R7: the co-hosted pair does not start)",
        gpu_type="a100-80",
        gpu_memory_utilization=0.90,
    ),
    Judge(
